<template>
    <div
        ...
        tabindex="-1"
        style="background: rgba(15, 23, 42, 0.92); z-index: 1060"
    ...
    >
        ...
        >
            ...
            >
                <!-- Dashboard Header -->
                <div
                    class="modal-header border-bottom border-secondary border-opacity-20 py-3.5 px-4 d-flex justify-content-between align-items-center"
                >
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5
                                class="modal-title text-white fw-extrabold mb-0"
                                style="font-size: 1.25rem"
                            >
                                Dashboard Admin Akreditasi
                            </h5>
                            <span class="text-slate-300 small">
                                Kelola pameran karya tugas akhir, media, laporan
                                PDF, dan inovator
                            </span>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                >
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    ...
                                                    :class="{
                                                        'bg-info bg-opacity-20 text-info border border-info border-opacity-30':
                                                            project.type ===
                                                            'web',
                                                        'bg-purple bg-opacity-20 text-purple border border-purple border-opacity-30':
                                                            project.type ===
                                                            'mobile',
                                    ...
                                    <td>
                                        <span class="small text-info-subtle">{{
                                            project.tech_field || "-"
                                        }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="badge bg-dark border border-secondary text-secondary extra-small"
                                        >
                                            {{
                                    ...
                                    <td class="text-end">
                                        <div
                                            class="d-flex align-items-center justify-content-end gap-1.5"
                                        >
                                            <button
                                                type="button"
