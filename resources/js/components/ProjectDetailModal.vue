            ...
            <div class="modal-content modal-content-glass" v-if="project">
                ...
                <div class="modal-header border-0 pb-0">
                    <div class="d-flex align-items-center">
                        <div
                            class="me-3 bg-dark rounded-circle p-2 d-flex justify-content-center align-items-center"
                ...
                <div class="modal-body py-4">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-4">
                        ...
                        >
                        <span
                            :class="['badge', getTypeBadgeClass(project.type)]"
                        >
                            {{ formatType(project.type) }}
                        </span>
                        <span
                            class="badge bg-secondary text-light text-capitalize"
                            >Prestasi: {{ project.prestasi_level }}</span
                        >
                    </div>
                    ...
                    <div class="mb-4">
                        <h5
                            class="fw-semibold text-white border-bottom border-secondary pb-2"
                        >
                            Deskripsi Proyek
                        </h5>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li
                                    ...
                                    :key="idx"
                                    class="d-flex align-items-start mb-2 text-secondary"
                                >
                    ...
                    <div class="mb-2">
                        <h5
                            class="fw-semibold text-white border-bottom border-secondary pb-2 mb-3"
                        >
                            Anggota Tim
                        </h5>
                        <div class="row row-cols-2 row-cols-md-4 g-3">
                            <div
                                class="col"
                                v-for="(member, idx) in project.team_members"
                                :key="idx"
                            >
                                <div
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            v-else
                                            class="team-avatar d-flex justify-content-center align-items-center text-white fw-bold fs-5"
                                        >
                                            {{
                                                member.nickname
                                                    .substring(0, 2)
                                    ...
                                    <span
                                        v-if="member.role"
                                        class="badge bg-dark border border-secondary text-secondary mb-3 w-100 text-truncate"
