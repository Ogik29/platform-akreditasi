        ...
        <transition name="loader-fade">
            <div class="vue-transition-loader" v-if="isTransitioning">
                <div class="text-center">
                    ...
                    <p class="text-white fw-bold mb-0" style="letter-spacing: 1px">
                        {{ transitionText }}
                    </p>
                </div>
            </div>
            ...
            <div v-if="currentView === 'grid'" key="grid">
                ...
                <header class="text-center mb-5 mt-4 fade-in-up">
                    <div class="float-animation">
                        <div class="d-inline-block px-3 py-1 mb-3 rounded-pill bg-dark bg-opacity-50 border border-secondary text-secondary fw-bold fade-in-up anim-delay-100"
                            style="
                                font-size: 0.85rem;
                                letter-spacing: 1px;
                                border-color: rgba(
                        ...
                        <h1 class="display-3 fw-extrabold text-white mb-3 fade-in-up anim-delay-200">
                            Pameran
                            <span class="text-gradient-silver">Teknologi</span>
                            &amp;
                            <span class="text-gradient-titanium">Inovasi</span>
                        </h1>
                        <p class="lead text-secondary mx-auto mb-4 fade-in-up anim-delay-300" style="max-width: 720px">
                        ...
                        <div class="row justify-content-center g-2 g-sm-3 mt-4"
                            style="max-width: 980px; margin: 0 auto">
                            <div class="col-6 col-sm-4 col-lg fade-in-up anim-delay-400">
                                <div class="glass-card stats-card-glow p-2 p-sm-3 text-center">
                                    <div class="fs-4 mb-1">🚀</div>
                                    <h3 class="fw-bold text-info mb-1 stats-number">
                                        {{
                                            animatedStats.projects ||
                                            projects.length
                                        }}
                                    </h3>
                                    <small class="text-secondary d-block stats-label">Total Proyek</small>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-lg fade-in-up anim-delay-500">
                                <div class="glass-card stats-card-glow p-2 p-sm-3 text-center">
                                    <div class="fs-4 mb-1">🏆</div>
                                    <h3 class="fw-bold mb-1 stats-number" style="color: #60a5fa">
                                        {{
                                            animatedStats.nasional ||
                                            totalNasional
                                        }}
                                    </h3>
                                    <small class="text-secondary d-block stats-label">Prestasi Nasional</small>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-lg fade-in-up anim-delay-500">
                                <div class="glass-card stats-card-glow p-2 p-sm-3 text-center">
                                    <div class="fs-4 mb-1">🌐</div>
                                    <h3 class="fw-bold mb-1 stats-number" style="color: #a78bfa">
                                        {{
                                            animatedStats.internasional ||
                                            totalInternasional
                                        }}
                                    </h3>
                                    <small class="text-secondary d-block stats-label">Prestasi Internasional</small>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-lg fade-in-up anim-delay-500">
                                <div class="glass-card stats-card-glow p-2 p-sm-3 text-center">
                                    <div class="fs-4 mb-1">🤝</div>
                                    <h3 class="fw-bold text-warning mb-1 stats-number">
                                        {{ animatedStats.mitra || totalMitra }}
                                    </h3>
                                    <small class="text-secondary d-block stats-label">Mitra Strategis</small>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-lg fade-in-up anim-delay-500">
                                <div class="glass-card stats-card-glow p-2 p-sm-3 text-center">
                                    <div class="fs-4 mb-1">👨‍🏫</div>
                                    <h3 class="fw-bold text-secondary mb-1 stats-number"
                                        style="color: #cbd5e1 !important">
                                        {{ animatedStats.dosen || 5 }}
                                    </h3>
                                    <small class="text-secondary d-block stats-label">Dosen Pembimbing</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="mb-5 fade-in-up anim-delay-500">
                    <div class="glass-card p-3 p-sm-4">
                        <div class="row g-4 align-items-center">
                            <!-- Search input -->
                            <div class="col-lg-6">
                                <label class="text-secondary small fw-bold mb-2 uppercase-tracking d-block">Cari
                                    Proyek</label>
                                <input type="text" v-model="searchQuery" class="form-control form-control-custom w-100"
                                    placeholder="Cari nama, tagline, fitur, atau mitra..." />
                            </div>

                            <!-- Supervisor filter -->
                            <div class="col-lg-6">
                                <label class="text-secondary small fw-bold mb-2 uppercase-tracking d-block">Dosen
                                    Pembimbing</label>
                                <select v-model="selectedSupervisor" class="form-select form-select-custom w-100">
                                    <option value="all">
                        ...
                        <div class="mt-4 pt-3 border-top border-secondary border-opacity-10">
                            <label class="text-secondary small fw-bold mb-3 d-block uppercase-tracking">Bidang
                                Teknologi</label>
                            <div class="d-flex flex-wrap gap-2">
                                <button type="button" @click="selectedTechField = 'all'" :class="[
                                    'btn-filter',
                                ...
                                <button type="button" @click="selectedTechField = 'AI'" :class="[
                                ...
                                <button type="button" @click="selectedTechField = 'IoT'" :class="[
                                ...
                                <button type="button" @click="selectedTechField = 'VR/AR'" :class="[
                                ...
                                <button type="button" @click="selectedTechField = 'Others'" :class="[
                        ...
                        <div class="mt-4 pt-3 border-top border-secondary border-opacity-10">
                            <label class="text-secondary small fw-bold mb-3 d-block uppercase-tracking">Jenis
                                Platform</label>
                            <div class="d-flex flex-wrap gap-2">
                                <button type="button" @click="selectedType = 'all'" :class="[
                                    'btn-filter',
                                ...
                                <button type="button" @click="selectedType = 'web'" :class="[
                                    'btn-filter',
                                ...
                                <button type="button" @click="selectedType = 'mobile'" :class="[
                                    'btn-filter',
                                    selectedType === 'mobile'
                                        ? 'active'
                                        : '',
                                ...
                                <button type="button" @click="selectedType = 'hardware'" :class="[
                                    'btn-filter',
                ...
                <!-- Empty State -->
                <div v-if="filteredProjects.length === 0" class="text-center py-5 glass-card fade-in-up">
                ...
                <transition-group v-else name="project-list" tag="div" class="row g-4">
                    <div v-for="project in filteredProjects" :key="project.id" class="col-12 col-md-6 col-lg-4">
                        <div class="glass-card h-100 p-3 p-sm-4 d-flex flex-column justify-content-between">
                            <!-- Dynamic background logo watermark -->
                            <div class="card-bg-logo" v-if="project.logo && hasRealLogo(project.logo)">
                                <img :src="project.logo" alt="Background Logo" />
                            </div>
                            ...
                            <div>
                                ...
                                <div class="d-flex justify-content-between align-items-start mb-3 gap-2">
                                    <div class="d-flex align-items-center" style="min-width: 0; flex: 1">
                                        ...
                                        <div class="logo-frame bg-dark bg-opacity-50 border border-secondary rounded-3 d-flex justify-content-center align-items-center me-3 flex-shrink-0 overflow-hidden"
                                            style="
                                                width: 50px;
                                                height: 50px;
                                                border-color: rgba(
                                            ...
                                            " :src="project.logo" alt="Logo" style="
                                                    width: 100%;
                                                    height: 100%;
                                                    object-fit: cover;
                                                " />
                                            <span v-else class="fs-4 fw-extrabold text-info">{{
                                                project.name
                                                    .substring(0, 2)
                                                    .toUpperCase()
                                            }}</span>
                                        ...
                                        <div style="min-width: 0; flex: 1">
                                            <h5 class="fw-bold text-white mb-0 text-truncate" :title="project.name">
                                                {{ project.name }}
                                            </h5>
                                            <span class="text-secondary text-truncate d-block"
                                                style="font-size: 0.75rem">Dosen:
                                                {{ project.supervisor }}</span>
                                        </div>
                                    </div>

                                    <!-- Partner Logo Placeholder / Image (Pojok Kanan Atas Card) -->
                                    <div class="partner-logo-container flex-shrink-0 ms-2 d-flex align-items-center gap-2"
                                        v-if="
                                            hasPartnerLogo(project) ||
                                            (project.partners &&
                                                project.partners.length > 0)
                                        ">
                                        <template v-if="hasPartnerLogo(project)">
                                            <div v-for="(
pLogo, pIdx
                                                ) in getPartnerLogos(project)" :key="pIdx"
                                                ...
                                                " :title="'Mitra: ' +
                                                    ...
                                                    ">
                                                <img :src="pLogo" alt="Logo Mitra" style="
                                                        width: 100%;
                                                        height: 100%;
                                                        object-fit: contain;
                                                    " />
                                        ...
                                        <template v-else>
                                            <div class="partner-logo-frame partner-placeholder-frame bg-dark bg-opacity-40 border border-warning border-opacity-30 rounded-3 p-1 d-flex flex-column align-items-center justify-content-center text-center"
                                                style="
                                                    width: 44px;
                                                    height: 44px;
                                                " :title="'Mitra: ' +
                                                ...
                                                <span style="
                                                        ...
                                                        line-height: 1;
                                                    ">🤝</span>
                                                <span class="text-warning fw-extrabold" style="
                                                        font-size: 0.55rem;
                                ...
                                <!-- Tagline -->
                                <h6 class="project-card-tagline fw-bold text-light opacity-75 mb-2">
                                    {{ project.tagline }}
                                </h6>
                                <!-- Description -->
                                <!-- <p
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <span class="text-secondary small">
                                        Prestasi:
                                        <span class="text-capitalize fw-bold text-white">{{ project.prestasi_level
                                        }}</span>
                                    </span>
                                </div>
                                <div class="d-flex gap-2">
                                    <button @click="handleShowcase(project)"
            ...
            <div v-else-if="currentView === 'detail' && selectedProject" key="detail"
                ...
                <div class="glass-card p-4 p-md-5 mb-5">
                    <div class="row align-items-center g-4">
                        <div
                            ...
                            <!-- Initials or logo image frame -->
                            <div class="logo-frame bg-dark bg-opacity-50 border border-secondary rounded-4 d-flex justify-content-center align-items-center flex-shrink-0 overflow-hidden"
                                style="
                                    width: 80px;
                                    height: 80px;
                                    border-color: rgba(
                                ...
                                " :src="selectedProject.logo" alt="Logo" style="
                                        width: 100%;
                                        height: 100%;
                                        object-fit: cover;
                                    " />
                                <span v-else class="fs-2 fw-extrabold text-info">{{
                            ...
                            <div>
                                ...
                                <p class="lead text-light mb-0" style="
                                        font-size: 1.05rem;
                                        line-height: 1.6;
                        ...
                        <div
                            ...
                            <div class="d-flex flex-wrap justify-content-center justify-content-md-end gap-2">
                                ...
                                <span
                                    ...
                                    style="font-size: 0.75rem">Prestasi:
                            ...
                            "
                                ...
                                <span class="text-white small fw-bold" style="color: #cbd5e1 !important">Mitra:</span>
                                <template v-if="hasPartnerLogo(selectedProject)">
                                    <div v-for="(pLogo, pIdx) in getPartnerLogos(
                                        selectedProject,
                                    )" :key="pIdx"
                                        ...
                                        style="width: 36px; height: 36px" :title="getPartnerName(
                                            selectedProject,
                                            pIdx,
                                        )
                                            ">
                                ...
                                <template v-else>
                                    <div class="partner-logo-frame partner-placeholder-frame bg-dark bg-opacity-40 border border-warning border-opacity-30 rounded-2 py-1 px-2 d-flex align-items-center justify-content-center gap-1"
                                        style="height: 36px">
                                        <span>🤝</span>
                                        <span class="text-warning fw-bold small">Mitra</span>
                                    </div>
                                </template>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <button type="button" @click="activeDetailTab = 'overview'" :class="[
                        'btn btn-detail-tab',
                    ...
                    <button type="button" @click="activeDetailTab = 'gallery'" :class="[
                        'btn btn-detail-tab',
                        activeDetailTab === 'gallery' ? 'active' : '',
                    ]">
                        <span class="tab-icon">📸</span>
                        <span>Dokumentasi</span>
                        <span v-if="getMediaCount(selectedProject) > 0"
                            class="badge bg-info text-dark ms-1 rounded-pill" style="font-size: 0.68rem">
                            {{ getMediaCount(selectedProject) }}
                        </span>
                    </button>

                    <button type="button" @click="activeDetailTab = 'prestasi'" :class="[
                        'btn btn-detail-tab',
                        ...
                        " class="badge bg-warning text-dark ms-1 rounded-pill" style="font-size: 0.68rem">
                            {{ selectedProject.funding_awards.length }}
                        </span>
                    </button>

                    <button type="button" @click="activeDetailTab = 'team'" :class="[
                        'btn btn-detail-tab',
                        ...
                        " class="badge bg-secondary text-white ms-1 rounded-pill" style="font-size: 0.68rem">
                ...
                <div v-if="activeDetailTab === 'overview'" class="fade-in-fast">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div v-if="selectedProject.type === 'web'" class="glass-card p-4 mb-4">
                                <h4 class="fw-bold text-white mb-4 d-flex align-items-center gap-2">
                                    <span>🌐 Platform Web Live</span>
                                </h4>
                                <div class="web-redirect-container text-center py-5 animate-pulse-subtle" style="
                                    ...
                                    <p class="text-light small mx-auto mb-4" style="
                                            max-width: 480px;
                                            color: #cbd5e1 !important;
                                        ">
                                    ...
                                    <a v-if="selectedProject.external_url" :href="selectedProject.external_url"
                                        target="_blank"
                                    ...
                                    <span v-else class="text-muted text-italic small">URL Website tidak tersedia</span>
                                </div>
                            </div>

                            <!-- Mobile Screenshots Slider (Mobile-based) -->
                            <div v-if="selectedProject.type === 'mobile'" class="glass-card p-4 mb-4">
                                <h4 class="fw-bold text-white mb-4 d-flex align-items-center gap-2">
                                ...
                                " class="screenshots-slider-wrapper">
                                    ...
                                    " @click="
                                        ...
                                        " class="btn-carousel-nav btn-carousel-nav-left" aria-label="Scroll Left">
                                    ...
                                    <div ref="mobileCarousel" class="screenshots-carousel-container" :class="{
                                        ...
                                        <div v-for="(
scr, idx
                                            ) in selectedProject.screenshots.slice(0, 4)" :key="idx"
                                            ...
                                            <div
                                                ...
                                                <img :src="scr"
                                                    ...
                                                    alt="Screenshot" @click="openLightbox(scr)" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    " @click="
                                        ...
                                        " class="btn-carousel-nav btn-carousel-nav-right" aria-label="Scroll Right">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                ...
                                " class="text-center mt-3">
                                    <button type="button" @click="activeDetailTab = 'gallery'"
                                        class="btn btn-sm btn-outline-info rounded-pill px-3 py-1.5"
                                        style="font-size: 0.82rem; border-color: rgba(56, 189, 248, 0.4);">
                                        <span>Lihat {{ selectedProject.screenshots.length - 4 }} screenshot lainnya di
                                            tab
                                            Dokumentasi ➔</span>
                                    </button>
                                </div>
                            ...
                            <!-- Video / Demonstration -->
                            <div v-if="selectedProject.video_url" class="glass-card p-4 mb-4">
                                <h4 class="fw-bold text-white mb-4 d-flex align-items-center gap-2">
                           ...
                           <div
                            ...
                            <div class="glass-card p-4 p-md-5 mb-4">
                                ...
                                <p class="text-light leading-relaxed mb-0" style="
                                        font-size: 1.02rem;
                                        line-height: 1.8;
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="glass-card p-4 mb-4">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <div>
                                        <span class="text-white d-block small mb-1 fw-bold"
                                            style="color: #cbd5e1 !important">Dosen
                                            Pembimbing</span>
                                    ...
                                    <div>
                                        <span class="text-white d-block small mb-1 fw-bold"
                                            style="color: #cbd5e1 !important">Bidang
                                            Teknologi</span>
                                        <span :class="[
                                    ...
                                    <div>
                                        <span class="text-white d-block small mb-1 fw-bold"
                                            style="color: #cbd5e1 !important">Prestasi</span>
                                    ...
                                    <hr class="my-2 border-secondary border-opacity-10" />
                                    <div>
                                        <span class="text-white d-block small mb-2 fw-bold"
                                            style="color: #cbd5e1 !important">Mitra
                                            Strategis</span>
                                        <div v-if="
                                            selectedProject.partners &&
                                            selectedProject.partners
                                        ...
                                        " class="d-flex flex-column gap-3 mt-2">
                                            <div v-for="(
partner, idx
                                                ) in selectedProject.partners" :key="idx"
                                                ...
                                                <div class="partner-logo-frame bg-dark bg-opacity-60 border border-secondary border-opacity-30 rounded-2 p-1.5 flex-shrink-0 d-flex align-items-center justify-content-center overflow-hidden me-2"
                                                    style="
                                                        width: 40px;
                                                        height: 40px;
                                                    ">
                                                ...
                                                <span class="text-white small fw-semibold flex-grow-1 ms-1" style="
                                                        line-height: 1.45;
                                                        font-size: 0.88rem;
                                                    ">
                                                    {{ partner }}</span>
                                        ...
                                        <span v-else class="text-muted text-italic small">Tidak ada mitra
                                            spesifik</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="glass-card p-4 mb-4">
                                ...
                                <ul class="list-unstyled mb-0 d-flex flex-column gap-3">
                                    <li v-for="(
feature, idx
                                        ) in selectedProject.features" :key="idx"
                                        class="d-flex align-items-start gap-2 text-white"
                                        style="color: #f1f5f9 !important">
                                        <span class="text-info mt-1" style="font-size: 1rem">✦</span>
                                        <span style="
                                                font-size: 0.93rem;
                                                line-height: 1.55;
                                                color: #e2e8f0 !important;
                ...
                <div v-else-if="activeDetailTab === 'gallery'" class="fade-in-fast">
                    <div class="glass-card p-4 p-md-5 mb-4">
                        <h4 class="fw-bold text-white mb-4 d-flex align-items-center gap-2">
                        ...
                        " class="mb-5">
                            <h6 class="text-secondary small fw-bold uppercase-tracking mb-3">
                                Foto Dokumentasi Kegiatan / Alat
                            </h6>
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                                <div v-for="(
doc, dIdx
                                    ) in selectedProject.documentations" :key="dIdx" class="col">
                                    <div
                                        ...
                                        <img :src="doc" alt="Dokumentasi"
                                            class="img-fluid rounded screenshot-static-img lightbox-trigger" style="
                                                max-height: 240px;
                                                width: 100%;
                                                object-fit: cover;
                        ...
                        ">
                            ...
                            <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 g-3">
                                <div v-for="(
scr, sIdx
                                    ) in selectedProject.screenshots" :key="sIdx" class="col">
                                    <div
                        ...
                        <div v-if="getMediaCount(selectedProject) === 0" class="text-center py-5">
                            <span class="fs-1 d-block mb-3">🖼️</span>
                ...
                <div v-else-if="activeDetailTab === 'prestasi'" class="fade-in-fast">
                    <div class="glass-card p-4 p-md-5 mb-4">
                        <h4
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6">
                                <div
                                    ...
                                    <span class="text-white small d-block mb-1 fw-bold"
                                        style="color: #cbd5e1 !important">Tingkat
                                        Prestasi</span>
                                    <h3 class="text-white fw-bold text-capitalize mb-2">
                                        {{ selectedProject.prestasi_level }}
                                    </h3>
                                    <p class="text-light small mb-0" style="color: #e2e8f0 !important">
                            ...
                            <div class="col-md-6">
                                <div
                                    ...
                                    <span class="text-warning small d-block mb-1 fw-bold"
                                        style="color: #fbbf24 !important">Status
                                        Pendanaan / Penghargaan</span>
                                    <h3 class="text-warning fw-bold mb-2" style="color: #fef08a !important">
                                        {{
                                            selectedProject.funding_awards &&
                                                selectedProject.funding_awards
                                                    .length
                        ...
                        ">
                            ...
                            <div class="d-flex flex-column gap-3">
                                <div v-for="(
award, aIdx
                                    ) in selectedProject.funding_awards" :key="aIdx"
                                    ...
                                    <div>
                                        ...
                                        <span class="text-secondary small">Terverifikasi oleh Tim Penilai
                ...
                <div v-else-if="activeDetailTab === 'team'" class="fade-in-fast">
                    <!-- Supervisor & Partner Spotlight -->
                    <div class="glass-card p-4 p-md-5 mb-5">
                        <div class="row g-4 align-items-center">
                            <div class="col-md-6 border-end border-secondary border-opacity-20 pe-md-4">
                                <span class="text-white small uppercase-tracking fw-bold d-block mb-2" style="
                                        color: #cbd5e1 !important;
                                ...
                                <span class="d-inline-flex align-items-center gap-1.5 px-3 py-1.5 rounded-pill" style="
                                        background: rgba(14, 165, 233, 0.18);
                                        border: 1px solid
                                            rgba(56, 189, 248, 0.4);
                                        font-size: 0.82rem;
                                    ">
                                    <span style="color: #38bdf8; font-weight: 600">Kode Dosen:</span>
                                    <strong class="text-white" style="font-weight: 700">{{
                                        selectedProject.supervisor
                                        }}</strong>
                                </span>
                            </div>
                            <div class="col-md-6 ps-md-4">
                                ...
                                " class="d-flex flex-wrap gap-2">
                                    <span v-for="(
pName, pI
                                        ) in selectedProject.partners" :key="pI"
                                        class="d-inline-flex align-items-center gap-2 py-2 px-3 rounded-3" style="
                                            background: rgba(
                                                245,
                                                158,
                                                11,
                                        ...
                                        ">
                                        <span>🤝</span>
                                        <span class="text-white fw-semibold" style="color: #ffffff !important">{{ pName
                                        }}</span>
                                    </span>
                                </div>
                                <span v-else class="text-muted text-italic small"
                                    style="color: #94a3b8 !important">Proyek Riset
                                    Mandiri / Akademik</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="glass-card p-4 p-md-5">
                        <h3 class="fw-extrabold text-white text-center mb-2 text-gradient-silver">
                            Tim Inovator Mahasiswa
                        </h3>
                        <p class="text-secondary text-center mx-auto mb-5" style="max-width: 600px">
                        ...
                        <div
                            ...
                            <div class="col" v-for="(
member, idx
                                ) in selectedProject.team_members" :key="idx">
                                <div class="team-member-card h-100 d-flex flex-column align-items-center text-center">
                                    <div class="team-avatar-container mb-3 position-relative">
                                        <div class="team-avatar-ring"></div>
                                        <img v-if="
                                            member.photo &&
                                            hasRealPhoto(member.photo)
                                        " :src="member.photo" :alt="member.nickname" class="team-avatar-img" />
                                        <div v-else
                                    ...
                                    <h5 class="text-white fw-bold mb-1 text-truncate w-100">
                                        {{ member.nickname }}
                                    </h5>
                                    <p class="text-white mb-2 small text-truncate w-100"
                                        style="color: #cbd5e1 !important">
                                        {{ member.fullname }}
                                    </p>
                                    ...
                                    <div class="d-flex gap-3 mt-auto">
                                        ...
                                        " :href="member.social_media.instagram
                                            " target="_blank" class="social-icon-btn" title="Instagram">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <div class="modal fade" id="mobileEmulatorModal" tabindex="-1" aria-labelledby="mobileEmulatorModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content modal-content-glass" v-if="activeMobileProject"
                            ...
                            <div class="phone-emulator-container mb-4">
                                <div class="phone-emulator">
                                    ...
                                    <div class="phone-screen text-start">
                                        ...
                                        <div class="bg-dark bg-opacity-25 rounded p-2.5 mb-3 border border-secondary"
                                            style="
                                                border-color: rgba(
                                                    255,
                                                    255,
                                            ...
                                            ">
                                            <h6 class="fw-bold text-white mb-1" style="font-size: 11px">
                                                Fitur Aplikasi:
                                            </h6>
                                            <ul class="list-unstyled mb-0 text-secondary" style="
                                                    font-size: 10px;
                                                    line-height: 1.45;
                                                ">
                                                <li v-for="(
feat, i
                                                    ) in activeMobileProject.features" :key="i" class="mb-1">
                                                    • {{ feat }}
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <!-- Screenshots -->
                                        <div class="row g-2 mb-3" v-if="
                                            activeMobileProject.screenshots &&
                                            activeMobileProject.screenshots
                                                .length > 0
                                        ">
                                            <div class="col-6" v-for="(
scr, idx
                                                ) in activeMobileProject.screenshots" :key="idx">
                                                <img :src="scr" class="img-fluid rounded border border-secondary"
                                                    alt="Mock Screen" style="
                                                        border-color: rgba(
                                                            255,
                                                            255,
                                                            255,
                                        ...
                                        <div class="bg-secondary bg-opacity-10 border border-secondary rounded p-2.5 text-center"
                                            style="
                                                border-color: rgba(
                                                    255,
                                                    255,
                                            ...
                                            ">
                                            <span class="text-light fw-bold d-block mb-1" style="font-size: 11px">Uji
                                                Fungsionalitas</span>
                                            <small class="text-muted" style="font-size: 9.5px">Silakan datangi stand
                                                pameran
                            ...
                            <div class="alert alert-secondary border border-secondary bg-dark bg-opacity-50 text-light text-start mb-0"
                                style="
                                    border-color: rgba(
                                        255,
                                        255,
                                ...
                                ">
                                <h6 class="alert-heading fw-bold mb-1" style="
                                        font-size: 0.85rem;
                        ...
                        <div class="modal-footer border-0">
                            <button type="button" class="btn btn-secondary w-100 py-2.5" data-bs-dismiss="modal" style="
            ...
            <div class="modal fade" id="videoPlayerModal" tabindex="-1" aria-labelledby="videoPlayerModalLabel"
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content modal-content-glass" v-if="activeHardwareProject">
                        <div class="modal-header border-0 pb-0">
                        ...
                        <div class="modal-body py-4">
                            ...
                            <div class="video-container mb-4" v-if="activeHardwareProject.video_url">
                                <iframe :src="getEmbedUrl(
                            ...
                            <div class="p-3 bg-dark bg-opacity-25 rounded border border-secondary mb-4" style="
                                    border-color: rgba(
                                        255,
                                        255,
                                        255,
                                ...
                                ">
                                <h6 class="fw-bold text-white mb-2" style="font-family: Outfit">
                                    Integrasi &amp; Komponen Hardware:
                                </h6>
                                <ul class="list-unstyled mb-0 text-secondary small" style="line-height: 1.6">
                                    <li v-for="(
feat, i
                                        ) in activeHardwareProject.features" :key="i" class="mb-1">
                                        ⚡ {{ feat }}
                                    </li>
                                </ul>
                            </div>

                            <div class="alert alert-secondary border border-secondary bg-dark bg-opacity-50 text-light mb-0"
                                style="
                                    border-color: rgba(
                                        255,
                                        255,
                                ...
                                <p class="small mb-0" style="
                                    ...
                                    }}</strong>. Silakan kunjungi stand kami untuk mencoba
                                    mengoperasikan prototipe secara langsung.
                                </p>
                            </div>
                        </div>
                        <div class="modal-footer border-0">
                            <button type="button" class="btn btn-secondary py-2.5 px-4" data-bs-dismiss="modal" style="
                                    background: rgba(255, 255, 255, 0.08);
                                    border-color: rgba(255, 255, 255, 0.1);
                                    color: white;
                                    border-radius: 12px;
    ...
    <Transition name="lightbox">
        <div v-if="isLightboxOpen" class="lightbox-overlay" @click.self="closeLightbox" @keydown.esc="closeLightbox"
            tabindex="0" ref="lightboxOverlay">
            ...
            <img :src="lightboxImage" class="lightbox-img" alt="Preview" @click.stop />
        </div>
    </Transition>
</template>
