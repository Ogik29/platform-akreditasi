<template>
                                ...
                                >
                                    ...
                                    <div>
                                        <button
                                            ...
                                            type="button"
                                            class="btn btn-sm rounded-pill fw-bold d-flex align-items-center gap-1.5 shadow-sm btn-admin-dashboard"
                                            @click="
                                        ...
                                        <button
                                            v-else
                                            type="button"
                                            class="btn btn-sm rounded-pill fw-bold d-flex align-items-center gap-1.5 btn-admin-enter"
    ...
    <AdminDashboardModal
        v-if="showAdminDashboardModal"
        :projects="projects"
        @close="showAdminDashboardModal = false"
        @logout="handleAdminLogout"
        @refresh-projects="refreshProjectsFromApi"
    />
</template>
...
import AdminDashboardModal from "./AdminDashboardModal.vue";
        ...
        async checkAdminSession() {
            try {
                ...
                if (response.data && response.data.user) {
                    this.currentAdminUser = response.data.user;
                }
            } catch (error) {
